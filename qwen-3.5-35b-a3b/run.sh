...
if [[ "$OS" == "Darwin" ]]; then
    ...
    # Memory fraction: 0.6 = ~77GB for model+KV cache, leaves room for other models
    GPU_MEM_FRAC="${GPU_MEM_FRAC:-0.6}"
    MODEL_HF="Qwen/Qwen3.5-35B-A3B-Instruct-AutoRound-int4-sym"
