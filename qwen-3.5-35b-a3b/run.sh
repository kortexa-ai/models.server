...
if [[ "$OS" == "Darwin" ]]; then
    ...
    # Explicit KV budget: 10 GiB, sized for four 64k requests
    # KV math: 2(K+V) * 40 layers * 2 kv_heads * 256 head_dim * 1 byte(fp8) * 65536 ctx * 4 reqs = 10 GiB
    ...
    CONTAINER_NAME="qwen-3.5-35b-a3b"
