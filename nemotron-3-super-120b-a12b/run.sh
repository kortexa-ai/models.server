...
# Nemotron-3-Super 120B-A12B on TRT-LLM (sourcebuild Docker)
# Config C from NVIDIA's AdvancedDeploymentGuide — 1x DGX Spark
...
echo "Starting Nemotron-3-Super 120B-A12B (NVFP4) via TRT-LLM"
echo "Image: ${IMAGE}"
echo "Model: ${MODEL}"
echo "Port: ${PORT}"
